        ...
        {messagesDummyData.map((msg, index) => (
          ...
          >
            {msg.image ? (
              <img
                src={msg.image}
                className="max-w-[130px] border border-gray-700 rounded-lg overflow-hidden mb-8"
              />
            ) : (
              <p
                className={`p-2 max-w-[250px] md:text-sm font-light rounded-lg mb-8 break-all bg-violet-500/30 text-white ${
